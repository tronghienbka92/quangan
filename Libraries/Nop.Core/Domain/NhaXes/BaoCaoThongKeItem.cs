...
namespace Nop.Core.Domain.NhaXes
{
    ...
    public class DoanhThuTheoThang
    {
        public string TenLaiXe { get; set; }
        public string BienSoXe { get; set; }
        public int SoNgayVanDoanh { get; set; }
        public decimal DoanhThuHopDong { get; set; }
        public decimal DoanhThuHopDongChuyen { get; set; }
    ...
    public class DoanhThuChiTietNgay
    {
     ...
     public class ListDoanhThuTongHop
     {
         ...
         public DoanhThuTongHop DTDN_TK { get; set; }
         public DoanhThuTongHop DTTK_DN { get; set; }
         public DoanhThuTongHop DTDN_CL { get; set; }
         public DoanhThuTongHop DTCL_DN { get; set; }
     }
