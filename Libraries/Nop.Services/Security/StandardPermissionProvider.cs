...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord CVHoatDongNangCao = new PermissionRecord { Name = "Quản lý các nghiệp vụ nâng cao", SystemName = "CVHoatDongNangCao", Category = "NhaXe" };
