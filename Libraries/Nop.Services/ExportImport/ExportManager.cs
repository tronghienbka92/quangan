    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual void ExportDTTongHopToXlsx(Stream stream, List<ListDoanhThuTongHop> DTTongHop, DateTime TuNgay, DateTime DenNgay)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                worksheet.Cells["B4"].Value = "Đà Nẵng - Tam Kỳ";

                worksheet.Cells["E4:G4"].Merge = true;
                worksheet.Cells["E4"].Value = "Tam Kỳ - Đà Nẵng";

                worksheet.Cells["H4:J4"].Merge = true;
                worksheet.Cells["H4"].Value = "Đà Nẵng - Chu Lai";

                worksheet.Cells["K4:M4"].Merge = true;
                worksheet.Cells["K4"].Value = "Chu Lai - Đà Nẵng";
                ...
                worksheet.Cells["E5"].Value = "Số lượt";
                worksheet.Cells["F5"].Value = "Số lượng";
                worksheet.Cells["G5"].Value = "Tổng doanh thu";

                worksheet.Cells["H5"].Value = "Số lượt";
                worksheet.Cells["I5"].Value = "Số lượng";
                worksheet.Cells["J5"].Value = "Tổng doanh thu";

                worksheet.Cells["K5"].Value = "Số lượt";
                worksheet.Cells["L5"].Value = "Số lượng";
                worksheet.Cells["M5"].Value = "Tổng doanh thu";


                worksheet.Cells["N4:N5"].Merge = true;
                worksheet.Cells["N4"].Value = "Tổng";

                worksheet.Cells["O4:O5"].Merge = true;
                worksheet.Cells["O4"].Value = "DT hợp đồng chuyến";
                ...
                foreach (var item in DTTongHop)
                {
                    ...
                    worksheet.Cells[row, col].Value = item.DTDN_TK.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTDN_TK.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTDN_TK.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DTTK_DN.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTTK_DN.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTTK_DN.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DTDN_CL.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTDN_CL.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTDN_CL.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DTCL_DN.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTCL_DN.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTCL_DN.ThanhTien.ToString("###,###");
                    col++;

                    decimal Tong = item.DTDN_TK.ThanhTien + item.DTTK_DN.ThanhTien + item.DTDN_CL.ThanhTien + item.DTCL_DN.ThanhTien ;
                ...
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_TK.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_TK.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_TK.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTTK_DN.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTTK_DN.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTTK_DN.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_CL.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_CL.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTDN_CL.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTCL_DN.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTCL_DN.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTCL_DN.ThanhTien).ToString("###,###");
                coltong++;
                ...
                //style body
                var modelRows = row;
                string modelRange = "A6:O" + modelRows.ToString();
                var modelTable = worksheet.Cells[modelRange];
                ...
                // Fill worksheet with data to export
                string _modelRange = "A4:O" + modelRows.ToString();
